...
exports.formatStellarError = formatStellarError;
/**
 * Utility to format complex Stellar/Horizon errors into user-friendly messages.
 */
function formatStellarError(error) {
    var _a, _b;
    const message = error instanceof Error ? error.message : String(error);
    const data = (_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data;
    const extras = data === null || data === void 0 ? void 0 : data.extras;
    // 1. Check for Horizon's result_codes (most specific)
    if ((_b = extras === null || extras === void 0 ? void 0 : extras.result_codes) === null || _b === void 0 ? void 0 : _b.operations) {
    ...
    if ((data === null || data === void 0 ? void 0 : data.title) === "Transaction Overshot") {
        return "Error: Transaction took too long to process (Timeout). The retry mechanism will handle this.";
    }
    if ((data === null || data === void 0 ? void 0 : data.title) === "Rate Limit Exceeded") {
        return "Error: Too many requests sent to the network. Please wait a moment.";
    }
    // 3. Fallback to common message patterns
    if (message.includes("404"))
        return "Error: Resource not found (404) on the network.";
    if (message.includes("429"))
        return "Error: Rate limited by the server.";
    return `Error: ${(data === null || data === void 0 ? void 0 : data.detail) || message}`;
}
